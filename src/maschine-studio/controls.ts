...
export const controls = {
    ...
    KNOB: new taktil.Control({ status: 0xb1, data1: 0x1d }),
    ...
    VOL_A: new taktil.Control({ status: 0xb7, data1: 0x67 }),
    VOL_B: new taktil.Control({ status: 0xb7, data1: 0x69 }),
    VOL_C: new taktil.Control({ status: 0xb7, data1: 0x6b }),
    VOL_D: new taktil.Control({ status: 0xb7, data1: 0x6d }),
    VOL_E: new taktil.Control({ status: 0xb7, data1: 0x6f }),
    VOL_F: new taktil.Control({ status: 0xb7, data1: 0x71 }),
    VOL_G: new taktil.Control({ status: 0xb7, data1: 0x73 }),
    VOL_H: new taktil.Control({ status: 0xb7, data1: 0x75 }),
